...
> Development of Avatar began in 1994
> Avatar premiered on December 10, 2009
...
### Plot
In 2154, the natural resources of the **Earth** have been **depleted** and is suffering **ecocide**. The Resources Development Administration (RDA) mines the valuable mineral **unobtanium** on **Pandora**, a moon in the **Alpha Centauri** star system. Pandora, whose atmosphere is inhospitable to humans, is inhabited by the **Na'vi**, 10-foot-tall (3.0 m), blue-skinned, sapient **humanoids** that live in harmony with nature. To explore Pandora, genetically matched human scientists use Na'vi-human hybrids called "avatars". ***Paraplegic Marine Jake Sully*** is sent to Pandora to replace his deceased identical twin, who had signed up to be an operator. Avatar Program head Dr. Grace Augustine considers Sully inadequate but accepts him as a bodyguard.
...
Depleted
: depletion is the consumption of a resource faster than it can be replenished.

Ecocide
: describes the mass destruction of nature by humans.

Unobtainium
: term used in fiction, engineering, and common situations for a material ideal for a particular application but impractically difficult to obtain.
